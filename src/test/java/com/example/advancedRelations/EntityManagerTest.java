...
import com.example.advancedRelations.dao.CustomerDAO;
...
public class EntityManagerTest {
    ...
    @Test
    void findAllDAOTest() {
        assertEquals(5, customerDAO.findAll());
    }

    @Test
    void findByIDDAOTest() {
        String name = customerDAO.findById(1L).get().getName().toString();
        assertEquals("Arnold Schwarzenegger", name);
    }
