...
public class PaginationTest {
    ...
    void pagination1Test() {
        ...
        Page<Customer> customerPage1 = customerRepository.findAll(page1);
        List<Customer> customers = customerPage1.getContent();
    ...
    void sortAndPagingTest() {
        ...
        Pageable pagingAndSort = PageRequest.of(0, 4, Sort.by("address"));
        Page<Customer> customerPage1 = customerRepository.findAll(pagingAndSort);
        List<Customer> laptops = customerPage1.getContent();
